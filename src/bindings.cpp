...
PYBIND11_MODULE(_smort, m) {
    ...
    m.def("get_size", py::overload_cast<const std::string&>(&get_size));
    m.def("get_width", py::overload_cast<const std::string&>(&get_width));
    m.def("get_height", py::overload_cast<const std::string&>(&get_height));
